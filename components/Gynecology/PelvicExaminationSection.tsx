...
import { Stethoscope, ShieldCheck, Lock, AlertCircle } from 'lucide-react';
        ...
        <div className="bg-white p-5 rounded-xl border border-pink-100 shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-900">Pelvic Examination</h3>
                        <p className="text-xs text-gray-500">Requires mandatory patient consent & female chaperone verification</p>
                    </div>
                </div>

                <label className="flex items-center gap-2 cursor-pointer">
                    <span className="text-xs font-semibold text-gray-700">Perform Pelvic Exam?</span>
                    <input
                        type="checkbox"
            ...
            {data.examinationPerformed && (
                <div className="space-y-4">
                    {/* Mandatory Safety Protocol Header */}
