    ...
    return (
        <div className="bg-white p-5 rounded-xl border border-pink-100 shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                ...
                {data.mainComplaint && (
                    <span className="px-3 py-1 bg-pink-100 text-pink-700 font-semibold text-xs rounded-full">
                        ...
                        return (
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                                    isPrimary
                                        ? 'bg-pink-600 text-white shadow-sm ring-2 ring-pink-600 ring-offset-1'
                                        : 'bg-gray-50 hover:bg-pink-50 text-gray-700 hover:text-pink-700 border border-gray-200'
                                }`}
                            >
                                {complaint}
                            </button>
                        ...
                        return (
                            <label
                                ...
                                className={`flex items-center gap-2 p-2 rounded-lg text-xs cursor-pointer border transition-colors ${
                                    checked ? 'border-pink-400 bg-pink-50/70 text-pink-900 font-medium' : 'border-gray-100 bg-gray-50/60 text-gray-600 hover:bg-gray-100'
                                }`}
                            >
                                <input
                                    type="checkbox"
