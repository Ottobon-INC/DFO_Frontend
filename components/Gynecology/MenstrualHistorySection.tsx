    ...
    return (
        <div className="bg-white p-5 rounded-xl border border-pink-100 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900">Menstrual History</h3>
                    <p className="text-xs text-gray-500">Track menarche, cycle length, regularity, flow intensity, and pain markers</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                ...
                {/* LMP Date */}
                <div>
                    <label className="block text-xs font-semibold text-gray-700 mb-1">LMP (Last Menstrual Period)</label>
                    <input
                        type="date"
                        value={data.lmpDate || ''}
