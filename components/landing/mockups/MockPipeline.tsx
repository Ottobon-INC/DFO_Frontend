...
export const MockPipeline: React.FC = () => {
    return (
        <div className="w-full h-full bg-brand-surface flex flex-col overflow-hidden relative select-none">
            <div className="h-10 border-b border-slate-100 flex items-center px-4 justify-between bg-brand-surface">
                ...
                {['New Leads', 'Contacted', 'Consultation'].map((col, i) => (
                    <div key={i} className="flex-1 flex flex-col">
                        ...
                        <div className="space-y-3">
                            <div className="bg-brand-surface p-3 rounded-lg shadow-sm border border-slate-100">
                            ...
                            {i === 0 && (
                                <div className="bg-brand-surface p-3 rounded-lg shadow-sm border border-slate-100 opacity-60">
