  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-brand-bg/50 overflow-hidden">
      ...
      <div className="flex-1 p-3 sm:p-4 md:p-6 overflow-y-auto flex flex-col lg:flex-row gap-4 lg:gap-6">
        {/* Triage Thread List */}
        <div className="w-full lg:w-1/3 lg:min-w-[300px] flex flex-col bg-brand-surface border border-brand-border rounded-xl lg:rounded-2xl shadow-sm overflow-hidden">
