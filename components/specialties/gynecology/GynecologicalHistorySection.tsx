                        ...
                        return (
                            <label
                                ...
                                className={`flex items-center gap-2 p-2.5 rounded-lg border text-xs cursor-pointer transition-colors ${
                                    checked ? 'border-blue-400 bg-blue-50 text-blue-900 font-medium' : 'border-gray-100 bg-gray-50/70 text-gray-600 hover:bg-gray-100'
                                }`}
                            >
                                <input
                                    type="checkbox"
                    ...
                    {SURGERIES_LIST.map((item) => {
                        ...
                        return (
                            <label
                                key={item.key}
                                className={`flex items-center gap-2 p-2.5 rounded-lg border text-xs cursor-pointer transition-colors ${
                                    checked ? 'border-indigo-400 bg-indigo-50 text-indigo-900 font-medium' : 'border-gray-100 bg-gray-50/70 text-gray-600 hover:bg-gray-100'
                                }`}
                            >
                                <input
                                    type="checkbox"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-3 py-1.5 text-xs border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                    />
                </div>
                <div>
